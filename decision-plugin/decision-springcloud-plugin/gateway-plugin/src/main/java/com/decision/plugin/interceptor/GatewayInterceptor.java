...
public class GatewayInterceptor implements InstanceAroundInterceptor {
    ...
    public void before(Object targetObject, Method method, Object[] allArguments, Class<?>[] parameterTypes) {
        ...
        if (null != parentIds && parentIds.size() > 0) {
            logger.info("gateway trace parentId: {}", parentIds.get(0));
        ...
        //advice.changeParameter(0, newExchange);
    }
    ...
    public void handleException(Object targetObject, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Throwable t) {
        logger.info("gateway trace throwing clean ");

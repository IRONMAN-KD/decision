package com.decision.plugin.servlet;
...
public class ServletPlugin implements DecisionPluginDefine {
    ...
    private static final String INTERCEPT_CLASS = "com.decision.plugin.servlet.interceptor.ServletInterceptor";
                ...
                new PluginInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> buildMethodsMatcher() {
                        return ElementMatchers.isMethod()
                                ...
                                .and(ElementMatchers.<MethodDescription>named("service"));
                    }

package com.decision.plugin.httpclient.v4;
...
@DecisionPlugin(id = "httpClientV4", version = "1.0.0", author = "KD")
public class HttpClientPlugin implements DecisionPluginDefine {
    private static final String ENHANCE_CLASS = "org.apache.http.client.HttpClient";
    private static final String INTERCEPT_CLASS = "com.decision.plugin.httpclient.v4.interceptor.HttpClientInterceptor";
                ...
                new PluginInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> buildMethodsMatcher() {
                        return ElementMatchers.isMethod()
                                .and(ElementMatchers.<MethodDescription>named("execute"));
                    }

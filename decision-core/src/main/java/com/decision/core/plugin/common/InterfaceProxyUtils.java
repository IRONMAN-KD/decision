...
import static com.decision.core.plugin.common.StringUtil.getJavaClassName;
import static com.decision.core.plugin.common.StringUtil.getJavaClassNameArray;
...
public class InterfaceProxyUtils {
    ...
    public static List<Method> getAllMethod(final Class<?> cls) {
        List<Method> methodList = new ArrayList<Method>(32);
